...
Financial machine learning is highly sensitive to data leakage and invalid validation procedures. The notebooks in this repository use chronological train/test splits where appropriate and avoid random shuffling for time-series forecasting tasks.
...
This repository is for educational purposes only. It does not constitute investment advice, financial advice, or a recommendation to trade any financial instrument. Historical performance and model backtests do not guarantee future results.
